...
class PhotoEditorFilterView: UIView {
    ...
    lazy var editButton: UIButton = {
        let button = UIButton(type: .system)
        button.setTitle("screen adjustment".localized, for: .normal)
        button.setTitleColor(.white.withAlphaComponent(0.5), for: .normal)
        button.setTitleColor(.white, for: .disabled)
    ...
    init(
        ...
        let originalFilter = PhotoEditorFilter(
            filterName: isVideo ? "Original".localized : "Original".localized
        )
...
class PhotoEditorFilterEditModel: Equatable {
    ...
    enum `Type` {
        ...
        var title: String {
            switch self {
            case .brightness:
                return "brightness".localized
            case .contrast:
                return "contrast".localized
            case .saturation:
                return "saturation".localized
            case .warmth:
                return "warmth".localized
            case .vignette:
                return "vignette".localized
            case .sharpen:
                return "sharpen".localized
            }
        }
