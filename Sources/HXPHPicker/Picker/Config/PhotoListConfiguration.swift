...
public struct PhotoListConfiguration {
    ...
    /// 每行显示数量
    public var rowNumber: Int = UIDevice.isPad ? 5 : 3
    ...
    public var allowAddText: Bool = true
    ...
    public var AddTextCell: AddTextCell = .init()
...
extension PhotoListConfiguration {
    ...
    public struct AddTextCell {
        ...
        /// Text Title
        public var title: String? = "Plain Text"
        
        /// Title Color
        public var titleColor: UIColor = "#EEEEEE".color
        
        /// Title Color in Dark Mode
        public var titleDarkColor: UIColor = "#ffffff".color
        
        /// Title Font
        public var titleFont: UIFont = .systemFont(ofSize: 14, weight: .bold)
